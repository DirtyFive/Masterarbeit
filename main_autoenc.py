...
flags.DEFINE_float("learning_rate",0.000001,"learning rate for the model")
...
def _main(argv):
	...
	if FLAGS.training == True:
		("building the Model")
		autoencoder1 = Autoencoder(FLAGS.learning_rate,FLAGS.batch_size,FLAGS.pointcloud_dim,FLAGS.epochs)
		autoencoder1.train()
